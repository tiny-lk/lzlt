...
namespace LZL.ForeignTrade.DataEntity
{
    public class SqlHelper
    {
        ...
        /// 打开连接(如果需要)并为命令指定连接信息、事务、命令类型以及参数信息。
        /// </summary>
        /// <param name="command">需要处理的<see cref="SqlCommand"/></param>
        /// <param name="connection">有效的<see cref="SqlConnection"/></param>
        /// <param name="transaction">有效的<see cref="SqlTransaction"/></param>
        ...
        /// <summary>
        /// 根据指定的数据库连接信息执行无返回值的存储过程
        /// </summary>
        /// <remarks>
        /// <example>
        /// <code>
        ///  int result = ExecuteNonQuery(connString, CommandType.StoredProcedure, "PublishOrders", new object[]{"Text"});
        /// </code>
        /// </example>
        /// </remarks>
        /// <param name="connectionString">连接字符串</param>
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        /// <summary>
        /// 默认构造。该类只提供静态的方法，使用私有的构造方法避免手动创建该类的多个实例
        /// </summary>
        ...
        /// <param name="spName">存储过程名</param>
        /// <param name="includeReturnValueParameter">参数中是否包含返回值参数</param>
        /// <returns></returns>
        ...
        /// <param name="connectionString">有效的连接字符串</param>
        /// <param name="commandText">存储过程名或T-SQL语句</param>
        /// <param name="commandParameters">缓存的参数列表</param>
        ...
        public static SqlParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            SqlParameter[] cachedParameters = (SqlParameter[])_ParamCache[hashKey];
        ...
        /// <remarks>
        /// </remarks>
        /// <param name="connectionString">用来创建<see cref="SqlConnection"/>对象的有效的连接字符串</param>
        /// <param name="spName">存储过程名</param>
        ...
        /// <param name="connectionString">用来创建<see cref="SqlConnection"/>对象的有效的连接字符串</param>
        /// <param name="spName">存储过程名</param>
        /// <param name="includeReturnValueParameter">参数中是否包含返回值</param>
        /// <returns>参数数组</returns>
