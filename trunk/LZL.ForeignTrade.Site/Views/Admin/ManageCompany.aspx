                    ...
                    <%
                        ...
                        else
                        {
                            if (p < count)
                            {
                                if (p == 1)
                                {
                                    Response.Write("上一页|" + Html.ActionLink("下一页", "ManageCompany", "Admin", new { page = p + 1 }, null));
                                }
                                else
                                {
                                    Response.Write(Html.ActionLink("上一页", "ManageCompany", "Admin", new { page = p - 1 }, null) + "|" + Html.ActionLink("下一页", "ManageCompany", "Admin", new { page = p + 1 }, null));  
                                }
                            }
                            else
                            {
                                Response.Write(Html.ActionLink("上一页", "ManageCompany", "Admin", new { page = p - 1 }, null) + "|下一页");
                            }
                        }
