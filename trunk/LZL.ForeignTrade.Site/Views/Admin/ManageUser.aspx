        ...
        <thead>
            <tr>
                ...
                <td colspan="2" align="left">
                    <input type="submit" class="button" id="Query" value="查 询" />
                    <input type="button" class="button" id="Edit" value="修 改" disabled="disabled" check="1" />
                    ...
                    <%
                        ...
                        else
                        {
                            if (p < count)
                            {
                                ...
                                {
                                    Response.Write(Html.ActionLink("上一页", "Admin", "ManageUser", new { page = p - 1 }, null) + "|" + Html.ActionLink("下一页", "Admin", "ManageUser", new { page = p + 1 }, null));   
                                }
                            }
                            else
                            {
