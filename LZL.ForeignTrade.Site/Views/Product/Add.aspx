...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        function opengys(regionname, childobject, khtype, addid) {
            $.ajax({
                type: "get",
                dataType: "html",
                data: { type: khtype },
                ...
                addRelationcontrol(regionname, childobject, data, addid);
                },
                error: function() {
                    alert("添加表单数据失败！");
                }
...
<asp:Content ID="Content3" ContentPlaceHolderID="ChildActionContent" runat="server">
    <li><a href="#" onclick="opengys('ProductCustomer♂','Customer♂ID','01','gysxx');">供应商信息</a></li>
    <li><a href="#" onclick="opengys('ProductCustomer♂','Customer♂ID','02','khspxx');">客户商品信息</a></li>
    <li>商品图片</li>
</asp:Content>
