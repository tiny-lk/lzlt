        ...
        <table width="100%" class="list" id="tabs-1">
            ...
            <thead align="center">
                ...
                <tr>
                    ...
                    <td align="left">
                        <%= Html.DropDownList("StockContracts♂TotalPackUnitCH", LZL.ForeignTrade.Controllers.DataHelper.GetDictionary("中文单位"), "请选择")%>
                    </td>
                    <td align="right">
                        包装毛重(KG)：
                    </td>
...
<asp:Content ID="ChildActionContent" ContentPlaceHolderID="ChildActionContent" runat="server">
    <a href="#" onclick="openckht('StockContractsExportContracts♂','ExportContracts♂ID','ckhtxx','<%=Url.Action("Details","ExportContracts")%>');"
        class="button">出口合同</a> <a href="#" onclick="addcontrol(this,'ProductSummaryControl','ProductSummary♂',1,'StockContracts')"
