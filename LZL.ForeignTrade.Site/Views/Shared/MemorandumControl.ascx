        ...
        <tr>
            ...
            <td style="width: 20%;" align="right">
                <%
                    if (Model == null)
                    {
                        Response.Write(Html.TextBox("Memorandum♂Date"));
                    }
                    else
                    {
                        Response.Write(Html.TextBox("Memorandum♂Date", Html.Encode(Model[i].Date)));
                    }
                %>
            </td>
            <td style="width: 20%;" align="right">
            ...
            <td style="width: 20%;" align="right">
                <%
                    if (Model == null)
                    {
                        Response.Write(Html.TextBox("Memorandum♂Subject"));
                    }
                    else
                    {
                        Response.Write(Html.TextBox("Memorandum♂Subject", Html.Encode(Model[i].Subject)));
                    }
                %>
            </td>
        </tr>
